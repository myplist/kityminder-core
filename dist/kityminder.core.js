         ...
         */
            ...
            createRelationship: function(fromNodeId, toNodeId, desc, dashed) {
                ...
                var vconnectMarker = new kity.Marker().pipe(function() {
                    ...
                    var arrow = new kity.Path().setTranslate(8, -3).setPathData(path).fill(color);
                    this.addShape(arrow);
                ...
                var provider = function(node, parent, connection) {
                    ...
                    var calcPoints = function(startNode, endNode) {
                        var startEnds = getConnectPoints(startNode, dashed), endEnds = getConnectPoints(endNode, dashed);
         ...
         */
            ...
            var ImageRenderer = kity.createClass("ImageRenderer", {
                ...
                update: function(imageGroup, node, box) {
                    ...
                    image.setUrl(url).setWidth(size.width | 0).setHeight(size.height | 0);
                    imageGroup.addShape(image);
                    var minusPath = "M9.60 5.92H0.64V4.32h8.96v1.60z";
                    var minus = new kity.Path().setTranslate(size.width + 4, 0).setPathData(minusPath).fill("white");
                    ...
                    var plus = new kity.Path().setTranslate(size.width + 4, 18).setPathData(plusPath).fill("white");
                    ...
                    if (imageUrl && imageUrl.indexOf("restapi.amap.com") !== -1) {
                        ...
                        var zoomIn = new kity.Path().setTranslate(size.width + 3, 36).setPathData(zoomInPath).fill("white");
                        ...
                        var zoomOut = new kity.Path().setTranslate(size.width, 56).setPathData(zoomOutPath).fill("white");
